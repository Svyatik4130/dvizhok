            ...
            <div className="flex w-full lg:w-10/12 m-auto mt-12 items-center lg:flex-row flex-col">
                <div className=" w-full mt-4 lg:mt-0 lg:w-4/12 px-4">
                    <div className="rounded-3xl bg-white p-5">
                        <img src="images/landing/share.png" className="m-auto" alt="МЕРЕЖА ТВОРЦІВ" />
                ...
                <div className=" w-full mt-4 lg:mt-0 lg:w-4/12 px-4">
                    <div className="rounded-3xl bg-white p-5">
                        <img src="images/landing/leaf.png" className="m-auto" alt="ПЛАТФОРМА МОЖЛИВОСТЕЙ" />
                ...
                <div className=" w-full mt-4 lg:mt-0 lg:w-4/12 px-4">
                    <div className="rounded-3xl bg-white p-5">
                        <img src="images/landing/partnership.png" className="m-auto" alt="СПІЛЬНОТА ОДНОДУМЦІВ" />
