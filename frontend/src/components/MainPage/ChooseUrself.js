    ...
    return (
        <div className="w-full bg-purple-950 mt-14">
            <div className="m-auto text-white w-full pt-7">
                <p className="text-center text-5xl font-bold">Оберіть для себе,хто Ви в майбутньому?</p>
            </div>
            <div className="pt-20 pb-10 flex flex-row w-10/12 text-white m-auto">
                <div className="w-4/12 pr-12">
                    <div>
                        <p className="text-4xl font-semibold text-center mb-3">ОКтивіст</p>
                ...
                <div className="w-4/12 px-12">
                    <div>
                        <p className="text-4xl font-semibold text-center mb-3">Творець</p>
                        <div className="h-0.5 w-full bg-pink-450 mb-3"></div>
                ...
                <div className="w-4/12 pl-12">
                    <div>
                        <p className="text-4xl font-semibold text-center mb-3">Лідер</p>
                        <div className="h-0.5 w-full bg-pink-450 mb-3"></div>
