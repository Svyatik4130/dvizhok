    ...
    return (
        <div className="w-full bg-purple-950 mt-14">
            <div className="m-auto text-white w-full pt-7">
                <p className="text-center text-5xl tracking-wide font-bold">Дорожня карта</p>
                <p className="text-center text-2xl tracking-wide mt-2 font-medium">Этапы создания и развития платформы DvizhOk</p>
            </div>
            <div className="w-full">
                <Carousel showStatus={false} className=" mt-24">
