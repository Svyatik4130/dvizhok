            ...
            <div className="w-full bg-purple-950">
                <div className="absolute z-40 w-full px-5 xl:p-0 xl:w-10/12 flex flex-col justify-between text-white h-5/6 left-0 right-0 ml-auto mr-auto">
                    ...
                    <div className="flex flex-col lg:flex-row justify-evenly">
                        ...
                        <button onClick={() => history.push(userData.user ? (userData.user.leaderReady ? ("/dashboard/projects/createproject") : ("/dashboard/projects/projectslist")) : ("/signup"))} className=" px-4 lg:px-12 py-4 lg:py-2 my-4 text-xl lg:text-3xl rounded-2xl font-semibold bg-white text-purple-950"> Додати проект  </button>
                    </div>
                </div>
