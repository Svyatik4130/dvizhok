    ...
    return (
        <div className="lg:w-8/9 w-full lg:fixed mt-12 lg:mt-0 pt-5 flex lg:flex-row flex-col items-center lg:pl-5 pl-0 bg-blur">
            <div className="flex lg:w-6/12 w-full items-center">
                <input type="text" className="lg:w-8/12 w-7/12 text-lg font-medium p-3 rounded-full outline-none" placeholder="Пошук людей чи проектів" />
                <div className="flex items-center ml-4 justify-center lg:w-4/12 w-5/12">
            ...
            <div className="lg:flex lg:w-6/12 hidden items-center">
